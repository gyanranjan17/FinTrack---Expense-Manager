        ...
        <CardContent>
            <div className="flex justify-around mb-6 text-sm">
                <div className="text-center">
                    ...
                    <p className="text-lg font-bold text-green-500">₹{totals.income.toLocaleString("en-IN", {
                ...
                <div className="text-center">
                    ...
                    <p className="text-lg font-bold text-red-400">₹{totals.expense.toLocaleString("en-IN", {
                    minimumFractionDigits: 2,
                    maximumFractionDigits: 2,
                    })}
                </p>
